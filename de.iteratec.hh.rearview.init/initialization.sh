...
sed -i -r 's/graphite\.host=.+/graphite.host="http:\/\/$GRAPHITE_HOST"/g' common.conf
...
sed -i -r 's/db\.default\.url=.+/db.default.url="jdbc:mysql://$LINKED_MYSQL_CONTAINER:3306/$MYSQL_DATABASE"/g' common.conf