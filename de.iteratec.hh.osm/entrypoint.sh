...
if [ -n "$OSM_ADMIN_USER" ] && [ -n "$OSM_ADMIN_PASSWORD" ] && [ -n "$OSM_ROOT_USER" ] && [ -n "$OSM_ROOT_PASSWORD" ] && [ -n "$MYSQL_DATABASE" ] && [ -n "$MYSQL_USER" ] && [ -n "$MYSQL_PASSWORD" ]
then
...
elif [ -z "$OSM_ADMIN_USER" ] && [ -z "$OSM_ADMIN_PASSWORD" ] && [ -z "$OSM_ROOT_USER" ] && [ -z "$OSM_ROOT_PASSWORD" ] && [ -z "$MYSQL_DATABASE" ] && [ -z "$MYSQL_USER" ] && [ -z "$MYSQL_PASSWORD" ] && [ ! -e $OSM_CONFIG_TARGET_LOCATION ]
then
